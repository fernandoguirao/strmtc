...
?>
<!DOCTYPE html>
<html manifest="<?php echo site_url();?>/wp-content/themes/klein-2.1.4/juego/offline.appcache">
<head>
    <meta charset="UTF-8" />
	...
	<link rel="manifest" href="<?php echo site_url();?>/wp-content/themes/klein-2.1.4/juego/app.manifest" />
...
<body> 12
	...
	<script src="<?php echo site_url();?>/wp-content/themes/klein-2.1.4/juego/jquery-2.0.0.min.js"></script>


	
    <!-- The runtime script.  You can rename it, but don't forget to rename the reference here as well.
    This file will have been minified and obfuscated if you enabled "Minify script" during export. -->
	<script src="<?php echo site_url();?>/wp-content/themes/klein-2.1.4/juego/c2runtime.php"></script>
    ...
    <p style="color:white!important;"><?php echo get_current_user_id();?></p>
</body> 
</html> 